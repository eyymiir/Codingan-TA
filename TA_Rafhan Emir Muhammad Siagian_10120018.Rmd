...
```{r}
plot(CAR_M, xlab = "Triwulan", ylab = "Nilai CAR", main = "Data CAR Bank M", type = "o")
abline(h = mean(CAR_M), lwd = 2,
lty = 2, col = 'red')
plot(NPL_M, xlab = "Triwulan", ylab = "Nilai NPL", main = "Data NPL Bank M", type = "o")
abline(h = mean(NPL_M), lwd = 2,
lty = 2, col = 'red')
plot(LDR_M, xlab = "Triwulan", ylab = "Nilai LDR", main = "Data LDR Bank M", type = "o")
abline(h = mean(LDR_M), lwd = 2,
lty = 2, col = 'red')
plot(ROA_M, xlab = "Triwulan", ylab = "Nilai ROA", main = "Data ROA Bank M", type = "o")
abline(h = mean(ROA_M), lwd = 2,
lty = 2, col = 'red')
plot(NIM_M, xlab = "Triwulan", ylab = "Nilai NIM", main = "Data NIM Bank M", type = "o")
abline(h = mean(NIM_M), lwd = 2,
lty = 2, col = 'red')
plot(BOPO_M, xlab = "Triwulan", ylab = "Nilai BOPO", main = "Data BOPO Bank M", type = "o")
abline(h = mean(BOPO_M), lwd = 2,
lty = 2, col = 'red')
plot(y_M, xlab = "Triwulan", ylab = "Nilai Tingkat Kesehatan", main = "Data Nilai Tingkat Kesehatan Bank M", type = "o")
...
```{r}
plot(CAR_CN, xlab = "Triwulan", ylab = "Nilai CAR", main = "Data CAR Bank CN", type = "o")
abline(h = mean(CAR_CN), lwd = 2,
lty = 2, col = 'red')
plot(NPL_CN, xlab = "Triwulan", ylab = "Nilai NPL", main = "Data NPL Bank CN", type = "o")
abline(h = mean(NPL_CN), lwd = 2,
lty = 2, col = 'red')
plot(LDR_CN, xlab = "Triwulan", ylab = "Nilai LDR", main = "Data LDR Bank CN", type = "o")
abline(h = mean(LDR_CN), lwd = 2,
lty = 2, col = 'red')
plot(ROA_CN, xlab = "Triwulan", ylab = "Nilai ROA", main = "Data ROA Bank CN", type = "o")
abline(h = mean(ROA_CN), lwd = 2,
lty = 2, col = 'red')
plot(NIM_CN, xlab = "Triwulan", ylab = "Nilai NIM", main = "Data NIM Bank CN", type = "o")
abline(h = mean(NIM_CN), lwd = 2,
lty = 2, col = 'red')
plot(BOPO_CN, xlab = "Triwulan", ylab = "Nilai BOPO", main = "Data BOPO Bank CN", type = "o")
abline(h = mean(BOPO_CN), lwd = 2,
lty = 2, col = 'red')
plot(y_CN, xlab = "Triwulan", ylab = "Nilai Tingkat Kesehatan", main = "Data Nilai Tingkat Kesehatan Bank CN", type = "o")
